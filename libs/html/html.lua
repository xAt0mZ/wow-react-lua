...
local function html_attr_escape(attr, val)
	...
	if Unsafe.is(val) then
		local safe_attrs = { align = true, alink = true, alt = true, bgcolor = true, border = true, cellpadding = true,
			cellspacing = true, class = true, color = true, cols = true, colspan = true, coords = true, dir = true,
			face = true, height = true, hspace = true, ismap = true, lang = true, marginheight = true, marginwidth = true,
			multiple = true, nohref = true, noresize = true, noshade = true, nowrap = true, ref = true, rel = true,
			rev = true, rows = true, rowspan = true, scrolling = true, shape = true, span = true, summary = true,
			tabindex = true, title = true, usemap = true, valign = true, value = true, vlink = true, vspace = true,
			width = true }
...
do
	local HtmlElementM = {}
	function HtmlElement(el) -- ({name, attrs}) => {}, string
		local tab = {
			tag = el[1],
			attrs = {},
			content = {},
...
for i = 1, #elements do
	local element, global = HtmlElement(elements[i]) -- __call
	html[global] = element
end
