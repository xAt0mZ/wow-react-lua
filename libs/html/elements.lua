...
--  void is used for void elements, which are not allowed to have closing tags
--  global is used to give a custom name for an element. This is used for table, because the element table clashes with the lua global
